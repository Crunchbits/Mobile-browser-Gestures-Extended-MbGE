...
let gesture = {
    ...
    pathFn = {
        ...
        'Analyze video': '/*ONLY TOP*/GM_openInTab("//jx.bozrc.com:4433/player/?url="+location.href);',
        'Baidu translate': 'GM_openInTab("//fanyi.baidu.com/#auto/auto/"+encodeURIComponent(gestureData.selectWords));',
        'Youdao translate': 'GM_openInTab("//dict.youdao.com/w/eng/"+encodeURIComponent(gestureData.selectWords));',
        ...
        'Open image source': 'GM_openInTab(gestureData.touchEle.src);',
        'Baidu image search': 'GM_openInTab("//graph.baidu.com/details?isfromtusoupc=1&tn=pc&carousel=0&promotion_name=pc_image_shituindex&extUiData%5bisLogoShow%5d=1&image="+gestureData.touchEle.src);',
...
function openSet() {
    ...
    function editGesture() {
        ...
        if (['Open settings', 'Video full screen', 'Gesture penetration'].indexOf(gestureName) > -1) { alert('This gesture script cannot be modified！'); return; }
